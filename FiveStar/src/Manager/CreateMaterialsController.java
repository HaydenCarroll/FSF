...
public class CreateMaterialsController {
	...
	public void enter() {
		Material mat = new Material(name.getText(), Double.parseDouble(cost.getText()), Double.parseDouble(amtSpent.getText()),Double.parseDouble(footageUsed.getText()), Double.parseDouble(amtSold.getText()),Double.parseDouble(price.getText()));
